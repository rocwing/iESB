...
public final class ServerConstants {
    ...
    public static final String CARBON_OSGI_REPO="carbon.osgi.repo.dir";
    public static final String CARBON_REPO="carbon.repository";
    ...
    public static final String TOMCAT_WEBAPP_DIR_PATH = "tomcat.webapp.path";
    ...
    //          Conf file names
    //=============================================
    public static final String CONF_FILE_NAME_CARBON_XML="carbon.xml";
    public static final String CONF_FILE_NAME_MGT_TRANSPORT_XML="mgt-transports.xml";
    public static final String CONF_FILE_NAME_AXIS2_XML="axis2.xml";        
    public static final String CONF_FILE_NAME_REGISTRY_XML="registry.xml";   
    public static final String CONF_FILE_NAME_USER_MGT_XML="user-mgt.xml";   
        
    //=============================================
    //          Folder names
    //=============================================
    public static final String FOLDER_NAME_REPOSITORY="repository";
    public static final String FOLDER_NAME_COMPONENTS="components";
    public static final String FOLDER_NAME_AXIS2_DEPLOYERS="axis2deployers";
    public static final String FOLDER_NAME_EXTENSIONS="extensions";
    public static final String FOLDER_NAME_OSGI_LIB="lib";
    public static final String FOLDER_NAME_OSGI_MEDIATORS="mediators";
    ...
    public static final String ADMIN_LOGGED_IN = "wso2carbon.admin.logged.in";
    ...
    public static final String ADMIN_USERNAME = "wso2carbon.admin.username";
    ...
    public final static String STS_NAME = "wso2carbon-sts";
