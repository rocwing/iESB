...
/**
 * GetAvgServiceResponseTime.java
 *
 ...
 */
            ...
            /**
            *  GetAvgServiceResponseTime bean class
            */
        
        public  class GetAvgServiceResponseTime
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       GetAvgServiceResponseTime.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getAvgServiceResponseTime",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getAvgServiceResponseTime",
    ...
    public static class Factory{
        ...
        */
        public static GetAvgServiceResponseTime parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetAvgServiceResponseTime object =
                new GetAvgServiceResponseTime();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getAvgServiceResponseTime".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetAvgServiceResponseTime)org.wso2.carbon.statistics.ui.types.axis2.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
